...
public class HttpILoveLifeReleaseUtil {
	
	private final static String ENV_ILOVELIFE_RELEASE = "i-love-life-release-ttxjb";
...
//			out = new PrintWriter(conn.getOutputStream());
	...
	public static String getCollection() {
		...
		jsonObject3.put("env", ENV_ILOVELIFE_RELEASE);
	...
	public static String addCollection(String collection) {
		...
		jsonObject.put("env", ENV_ILOVELIFE_RELEASE);
	...
	public static String delCollection(String collection) {
		...
		jsonObject.put("env", ENV_ILOVELIFE_RELEASE);
		jsonObject.put("collection_name",collection);
		String url2 = "https://api.weixin.qq.com/tcb/databasecollectiondelete?access_token="+HttpILoveLifeReleaseUtil.getAccessToken();
		String s2 = HttpILoveLifeReleaseUtil.sendPost(url2, jsonObject.toString());
		return s2;
	}
	...
	public static String addDatabase(String query) {
		...
		jsonObject4.put("env", ENV_ILOVELIFE_RELEASE);
...
//				+ "tags: [\"cloud\",\"database\"],location: new db.Geo.Point(113, 23),done: false}]})";
	...
	public static void uploadFile(String path, String file) {
        ...
        UploadUtil.formUpload(url5, textMap, fileMap,contentType);
	}
