...
//    	218072, 240693, 263343, 285989, 308563, 331033, 353350, 375494, 397447, 419210, 440795, 462224, 483532, 504758 };  
    ...
    public static String getLunar(String year, String month, String day) {  
        ...
        sy = (SY - 4) % 12;  
        System.out.println("SY=" + SY + "SM=" + SM + "SD=" + SD + "sy=" + sy);  
        Calendar cl = Calendar.getInstance();  
        cl.set(SY, SM - 1, SD);  
        sDObj = cl.getTime();  
        //日期  
    ...
    public static void main(String[] args) {  
        System.out.println(getLunar("2005", "8", "2"));  
        ...
        System.out.println(getLunar("2016", "10", "31"));
        System.out.println(getLunar("2020", "3", "3"));
        
        Calendar cal = Calendar.getInstance();
        System.out.println(getLunar(cal.get(Calendar.YEAR)+"", cal.get(Calendar.MONTH)+1+"", cal.get(Calendar.DAY_OF_MONTH)+""));
