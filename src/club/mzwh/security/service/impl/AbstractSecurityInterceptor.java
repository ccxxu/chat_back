...
public abstract class AbstractSecurityInterceptor implements InitializingBean, ApplicationEventPublisherAware,
	 ...
	 * secure object invocation has been
	 * completed. This method should be invoked after the secure object
	 * invocation and before afterInvocation regardless
	 * of the secure object invocation returning successfully (i.e. it should be
	 * done in a finally block).
	 * 
	 * @param token
	...
	protected Object afterInvocation(InterceptorStatusToken token, Object returnedObject) {
		...
		finallyInvocation(token); // continue to clean in this method for
									// passivity
	 ...
	 * If you set this property to {@code true}, {@code AuthorizedEvent}s will
	 * also be published.
	 * 
	 ...
	 * <tt>true</tt>), essentially you are ensuring
	 * that every secure object invocation advised by
	 * <code>AbstractSecurityInterceptor</code> has a configuration
	 * attribute defined. This is useful to ensure a "fail safe" mode where
	 * undeclared secure objects will be rejected
	 * and configuration omissions detected early. An
	 * <tt>IllegalArgumentException</tt> will be thrown by the
	 * <tt>AbstractSecurityInterceptor</tt> if you set this property to
	 * <tt>true</tt> and an attempt is made to invoke
	 ...
	 *            configuration attributes (by default it is <code>false</code>
