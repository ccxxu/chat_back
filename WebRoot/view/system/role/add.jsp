	...
	<body class="white-bg">
		<div class="wrapper wrapper-content animated fadeInRight ibox-content">
			<form class="form-horizontal m" id="form-role-add">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label is-required">角色描述：</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="descc" id="descc" required>
					</div>
				</div>
				<div class="form-group">
	 	...
	 	<script>
	        function submitHandler() {
		        if ($.validate.form()) {
		            $.operate.save("${ctx}/system/role/save", $('#form-role-add').serialize());
		        }
		    }
	    </script>
	</body>
