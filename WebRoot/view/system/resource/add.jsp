	...
	<body class="white-bg">
		<div class="wrapper wrapper-content animated fadeInRight ibox-content">
			<form class="form-horizontal m" id="form-menu-add">
				...
				<input id="treeId" name="parentId" type="hidden" value="${pid}" />
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<label class="radio-box"> <input type="radio" name="showType" value="0" checked/> 目录 </label> 
						<label class="radio-box"> <input type="radio" name="showType" value="1" /> 菜单 </label> 
						<label class="radio-box"> <input type="radio" name="showType" value="2" /> 按钮 </label>
					</div>
				</div>
				<div class="form-group">
