		...
		$(function() {
		    ...
		    var options = {
		        ...
		        columns: [{
		            ...
		            formatter: function(value, row, index) {
		                var actions = [];
		                actions.push('<a class="btn btn-success btn-xs ' + editFlag + '" href="javascript:void(0)" onclick="doEdit(\'' + row.fdid + '\')"><i class="fa fa-edit"></i>编辑</a> ');
		                actions.push('<a class="btn btn-success btn-xs ' + editFlag + '" href="javascript:void(0)" onclick="doKey(\'' + row.fdid + '\')"><i class="fa fa-key"></i>修改主键</a> ');
		                actions.push('<a class="btn btn-info btn-xs ' + addFlag + '" href="javascript:void(0)" onclick="doAdd(\'' + row.id + '\')"><i class="fa fa-plus"></i>新增</a> ');
		                if (row.hasSub == '0') {
