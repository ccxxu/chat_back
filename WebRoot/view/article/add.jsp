...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="tab-content">
			<div class="tab-pane active" id="user_info">
				<form class="form-horizontal" id="form-article-add">
		            ...
		            <input id="mainColKey" name="mainColKey" type="hidden" value="" />
		            <input id="slaveColKey" name="slaveColKey" type="hidden" value="" />
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-11 article_right">
		                    <input type="text" class="form-control" id="shortTitle" name="shortTitle" value="" placeholder="请输入二级标题">
		                </div>
		            </div>
		            <div class="form-group">
		                <label class="control-label article_left">子站标题：</label>
		                <div class="col-sm-11 article_right">
		                    <input type="text" class="form-control" id="subTitle" name="subTitle" value="" placeholder="请输入子站标题">
		                </div>
		            </div>
		            <div class="form-group">
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-11 article_right">
		                    <input type="text" class="form-control" id="author" name="author" value="" placeholder="请输入文章作者">
		                </div>
		            </div>
		            <div class="form-group">
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-11 article_right">
		                    <input type="text" class="form-control" onclick="selectColTree(1)" id="mainColName" name="mainColName" readonly="true" value="" placeholder="请输入文章栏目1">
		                </div>
		            </div>
		            <div class="form-group">
		                <label class="control-label article_left">文章栏目2：</label>
		                <div class="col-sm-11 article_right">
		                    <input type="text" class="form-control" onclick="selectColTree(2)" id="slaveColName" name="slaveColName" readonly="true" value="" placeholder="请输入文章栏目2">
		                </div>
		            </div>
		            <div class="form-group">
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-3 article_right">
		                    <input type="text" style="position:absolute;width:100px;" class="form-control time-input" id="pubDate01" data-format="yyyy-MM-dd" name="pubDate01" value="" placeholder="2000-01-01">
		                    <input type="text" style="position:inherit;width:100px;margin-left:120px" class="form-control time-input" id="pubDate02" data-format="HH:mm" data-type="time" name="pubDate02" value="" placeholder="00:00">
		                </div>
		            </div>
		            <div class="form-group">
		            ...
		            <div class="form-group">
	                    <div class="col-sm-offset-2 col-sm-10">
	                        <button type="button" class="btn btn-sm btn-primary" onclick="submitArticle()"><i class="fa fa-check"></i>保 存</button>&nbsp;
		...
		<script type="text/javascript">
		    ...
		    ue.ready(function() {
				//设置编辑器的内容"
				ue.setContent("12321"); // date为动态传入的数据
				//获取编辑器带格式的内容
