...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="container-div">
		<div class="row">
            ...
            <div class="btn-group-sm" id="toolbar" role="group">
                ...
                <a class="btn btn-primary single disabled" onclick="doEdit()" >
	...
	<script type="text/javascript">
		    ...
		    var options = {
		        ...
		        columns: [{
		            ...
		            formatter: function(value, row, index) {
		                ...
		                actions.push('<a class="btn btn-success btn-xs ' + addFlag + '" href="javascript:void(0)" onclick="doRecom(\'' + row.id + '\')"><i class="fa fa-file"></i> 今日推荐</a> ');
		...
		function doAdd() {
			var url = prefix+"/add";
			$.modal.open("添加文章", url, 900, 600);
		}
		
		function doEdit(id) {
			var url = prefix+"/edit/"+id;
			$.modal.open("修改文章", url, 900, 600);
		}
		
		function doRecom(id) {
			$.modal.confirm("确认要将当前文章设置成今日推荐吗？", function() {
				$.operate.post(prefix + "/recommond", { "id": id});
		    });
		}
	</script>
</body>
